...
export default function BooksSection() {
  ...
  <input
    type="text"
    placeholder="Search"
    className="w-full border rounded-lg py-2 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-pink-500"
  />
              ...
              >
                ...
                <div className="flex flex-col items-end justify-between">
                  ...
                  <div className="flex gap-2">
                    <button className="bg-pink-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm">
                      <FaShoppingCart />
                      Add To Cart
                    </button>
                    <button className="border border-pink-600 text-pink-600 p-2 rounded-lg">
                      <FaRegHeart />
                    </button>
                  </div>
                </div>
